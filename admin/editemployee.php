...
$sql="update tblemployees set FirstName=:fname,LastName=:lname,Gender=:gender,Dob=:dob,Department=:department,Address=:address,City=:city,Country=:country,Phonenumber=:mobileno Phonenumber=:mobileno,bank=:bank,AccountName=:acctname,AccountNo=:acctnum,NextOfKin=:nextkin,MaritalStatus=:marital,NextOfKinAddr=:kinaddr,NextOfKinPhoneNum=:kinphonenum where id=:eid";
...
<div class="input-field m12 col s12 l6">
...
<input id="bank" readonly name="bank" type="text" value="<?php echo htmlentities($result->bank);?>" autocomplete="off" required>
</div>
...
<input id="birthdate" name="dob" placeholder="date of birth" readonly class="datepicker" value="<?php echo htmlentities($result->Dob);?>" >
</div>
...
<input id="acctnum" readonly name="acctnum" type="text" value="<?php echo htmlentities($result->AccountNo);?>" autocomplete="off" required>
</div>

<div class="input-field col m12 s12 l6">
<label for="next-of-kin">next of kin</label>
<input id="kin" name="kin" readonly type="text" value="<?php echo htmlentities($result->NextOfKin);?>" autocomplete="off" required>
</div>

<div class="input-field col m12 s12 l6">
<label for="marital">marital status</label>
<input id="kin" name="marital" readonly type="text" value="<?php echo htmlentities($result->MaritalStatus);?>" autocomplete="off" required>
</div>

<div class="input-field col m12 s12 l6">
<label for="next-of-kin">next of kin address </label>
<input id="kin" name="kinaddr" readonly type="text" value="<?php echo htmlentities($result->NextOfKinAddr);?>" autocomplete="off" required>
</div>

<div class="input-field col m12 s12 l6">
<label for="next-of-kin">next of kin phone number</label>
<input id="kin" name="kinnum" readonly type="text" value="<?php echo htmlentities($result->NextOfKinPhoneNum);?>" autocomplete="off" required>
</div>


<div class="input-field col m12 s12 l12">
<label for="next-of-kin">Account name</label>
<input id="acctn" readonly name="acctname" type="text" value="<?php echo htmlentities($result->AccountName);?>" autocomplete="off" required>
</div>
